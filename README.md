# RebornCop Max II Option Rom Dump

## About RebornCop Max II
RebornCop Max 2 is a hardware-based Instant Recovery Software (similar to Deep Freeze) that was sold in South Korea around 2008.

It is known to operate by intercepting the boot process in the form of an Option ROM.

This ROM image was dumped from the Winbond Electronics W27C512-45Z EEPROM that was attached to the RTL8139D network card.
